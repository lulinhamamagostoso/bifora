...
Aguardo orientação para iniciar.`;
    ...
    const renderCover = () => (
        ...
        >
            ...
            >
                <span className="block whitespace-nowrap text-[clamp(1.25rem,5.8vw,2.75rem)]">{'Seu caso tem solução'}</span>
                <span className="block whitespace-nowrap text-[clamp(1rem,4.8vw,2.25rem)] text-brand mt-1">{'Descubra em 60 segundos'}</span>
            </motion.h1>
