...
var MASK_PROPS = {
  // common
  mask: import_prop_types.default.oneOfType([import_prop_types.default.array, import_prop_types.default.func, import_prop_types.default.string, import_prop_types.default.instanceOf(RegExp), import_prop_types.default.oneOf([Date, Number, IMask.Masked]), import_prop_types.default.instanceOf(IMask.Masked)]),
  value: import_prop_types.default.any,
  unmask: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.oneOf(["typed"])]),
  prepare: import_prop_types.default.func,
  prepareChar: import_prop_types.default.func,
  validate: import_prop_types.default.func,
  commit: import_prop_types.default.func,
  overwrite: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.oneOf(["shift"])]),
  eager: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.oneOf(["append", "remove"])]),
  skipInvalid: import_prop_types.default.bool,
  // events
  onAccept: import_prop_types.default.func,
  onComplete: import_prop_types.default.func,
  // pattern
  placeholderChar: import_prop_types.default.string,
  displayChar: import_prop_types.default.string,
  lazy: import_prop_types.default.bool,
  definitions: import_prop_types.default.object,
  blocks: import_prop_types.default.object,
  // enum
  enum: import_prop_types.default.arrayOf(import_prop_types.default.string),
  // range
  maxLength: import_prop_types.default.number,
  from: import_prop_types.default.number,
  to: import_prop_types.default.number,
  // date
  pattern: import_prop_types.default.string,
  format: import_prop_types.default.func,
  parse: import_prop_types.default.func,
  autofix: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.oneOf(["pad"])]),
  // number
  radix: import_prop_types.default.string,
  thousandsSeparator: import_prop_types.default.string,
  mapToRadix: import_prop_types.default.arrayOf(import_prop_types.default.string),
  scale: import_prop_types.default.number,
  normalizeZeros: import_prop_types.default.bool,
  padFractionalZeros: import_prop_types.default.bool,
  min: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.instanceOf(Date)]),
  max: import_prop_types.default.oneOfType([import_prop_types.default.number, import_prop_types.default.instanceOf(Date)]),
  // dynamic
  dispatch: import_prop_types.default.func,
  // ref
...
function IMaskMixin(ComposedComponent) {
  var _Class;
  const MaskedComponent = (_Class = class MaskedComponent extends import_react.default.Component {
    constructor(props) {
      super(props);
    ...
    render() {
      return import_react.default.createElement(ComposedComponent, {
  ...
  return import_react.default.forwardRef((props, ref) => import_react.default.createElement(MaskedComponent, {
    ...props,
    ref
  }));
}
...
var IMaskInputFn = (props, ref) => import_react2.default.createElement(IMaskInputClass, {
  ...props,
  ref
});
var IMaskInput = import_react2.default.forwardRef(IMaskInputFn);
...
function useIMask(opts, _temp) {
  ...
  const [lastAcceptState, setLastAcceptState] = (0, import_react3.useState)({});
  const [value, setValue] = (0, import_react3.useState)("");
  const [unmaskedValue, setUnmaskedValue] = (0, import_react3.useState)("");
  const [typedValue, setTypedValue] = (0, import_react3.useState)();
  const _destroyMask = (0, import_react3.useCallback)(() => {
    var _maskRef$current;
    (_maskRef$current = maskRef.current) == null || _maskRef$current.destroy();
    maskRef.current = null;
  }, []);
  const storeLastAcceptedValues = (0, import_react3.useCallback)(() => {
  ...
  const _onAccept = (0, import_react3.useCallback)((event) => {
    const m = maskRef.current;
    if (!m) return;
    storeLastAcceptedValues();
    onAccept == null || onAccept(m.value, m, event);
  }, [onAccept]);
  const _onComplete = (0, import_react3.useCallback)((event) => maskRef.current && (onComplete == null ? void 0 : onComplete(maskRef.current.value, maskRef.current, event)), [onComplete]);
  ...
  (0, import_react3.useEffect)(() => _destroyMask, [_destroyMask]);
  return {
    ref,
    maskRef,
    value,
